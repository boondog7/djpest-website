...
def investment(c):
    ...
    rodents = T(["Service", "What it covers", "Typical range"], [
        ...
        ["Bee hive treatment (accessible entry)", "Evening treatment of an established hive in a wall or roof void, entry sealed, follow-up check and a comb-removal plan. Swarms are referred to a beekeeper for live collection at no charge.", "$320 – $480"],
        ["Bed bug two-visit program", "Inspection-led treatment of every harbourage with a residual, insect growth regulator and desiccant dust, second visit at ten to fourteen days. One bedroom at the low end, a whole three-bedroom home at the top. 30-day re-treatment period.", "$450 – $950"],
        ["Commercial program (per visit)", "Cafes, strata, childcare, aged care, offices and warehouses, quoted per visit after a site survey. See the commercial page for indicative ranges by site type.", "$160 – $420"],
    ...
    body += c["section"](c["eyebrow"]("What moves the investment") + '<div class="section-head"><h2>Why your quote lands where it does</h2><p class="lead">Four things account for almost every difference between the low and high end of a range. We tell you which apply to your property on the quote itself.</p></div>' + movers + '<p>For the long version, with the six things that move a quote and the questions that expose a bad one, read <a href="/blog/how-much-does-pest-control-cost">how much pest control costs in Perth</a>.</p>', "ledger")
...
def whats_my_pest(c):
    ...
    cards = [
        ...
        ("/bed-bug-treatment-perth", "Bites overnight", "Small itchy welts in lines or clusters, worse on arms and legs; dark dots along the mattress seam.", "Bed bugs if there is spotting on the seams or a trip or second-hand bed in the last month; fleas if you have pets and carpet. Bed bugs get a two-visit program; fleas a vacate-style treatment. Both carry a 30-day re-treatment period."),
        ...
        ("/wasp-removal-perth", "Wasps around the eaves", "Repeated wasp traffic to one point under the roofline, a pergola beam or a wall vent; a grey comb with open cells.", "A paper wasp nest. We treat and remove accessible nests with a 30-day re-treatment period. Stocky yellow-and-black wasps in numbers around food may be European wasps: photograph and report to DPIRD, do not disturb."),
        ("/bee-removal-perth", "Bees in and out of a weep hole", "Steady bee traffic to one brick joint, vent or roof edge for weeks; a hum in the wall; or a football-sized cluster hanging on a branch that appeared overnight.", "Traffic to a wall is an established hive; a cluster in the open is a swarm. Swarms go to a beekeeper alive at no charge. Hives in cavities are treated in the evening and sealed, with a comb-removal plan."),
        ("/commercial-pest-control-perth", "Cockroaches in the shop kitchen", "Small brown cockroaches in the coffee machine, behind the fryer or in the dishwasher; droppings in the store; an inspection due.", "German cockroaches in a food business. A documented monthly program with gel, IGR, monitors and same-day reports, set up so the EHO or HACCP auditor finds what they need."),
...
def contact(c):
    ...
    body += c["section"]('<div class="grid grid-2" style="gap:3rem;align-items:start"><div class="prose">'
        ...
        '</div><div class="card" style="min-height:280px;display:grid;place-items:center;text-align:center"><div><div class="num">Map</div><p>Warwick, WA 6024. Servicing Perth&rsquo;s northern and inner-northern suburbs, from Subiaco and Bayswater up through Joondalup and Wanneroo to the coast at Yanchep.</p><p><a href="/service-areas">See the suburb list</a></p></div></div></div>', "")
