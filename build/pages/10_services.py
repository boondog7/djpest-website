...
{art_html}
    ...
    co_faqs = [
        ...
        ("Which areas do you cover for commercial work?", "Every suburb within about fifteen kilometres of Warwick, from the inner north and the western beaches up through Joondalup and Wanneroo, plus the coast to Alkimos and Yanchep. Keeping the run tight is how we hold monthly investment ranges down and turn up on time."),
    ]
