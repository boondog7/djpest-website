...
{art_html}
    ...
    ro_faqs = [
        ("How do I tell if I have rats or mice?", "Rats leave droppings roughly 10 to 20 mm long depending on species (roof rats, the usual Perth culprit, around 12 mm and pointed; Norway rats up to 20 mm and blunt), gnaw holes the size of a 50-cent coin and thump across the roof void at night. Mice leave rice-grain droppings of 3 to 6 mm, gnaw smaller holes and scurry. Black rats, the usual northern-suburbs roof invader, are climbers; Norway rats are ground and sub-floor animals. Treatment differs, so we identify first."),
    ...
    co_faqs = [
        ...
        ("Which areas do you cover for commercial work?", "Perth's northern and inner-northern suburbs: the Balcatta, Wangara and Malaga industrial precincts, the inner north and western beaches, up through Joondalup and Wanneroo to Alkimos and Yanchep. Keeping the run tight is how we hold monthly investment ranges down and turn up on time."),
    ]
