...
"Warwick": dict(
    ...
    h1="Pest control in Warwick, from the suburb we live in.",
    ...
    faqs=[
        ("Do you charge a call-out fee in Warwick?", "No. There is no call-out fee anywhere in our service area, and Warwick is where we are based, so there is no travel component in a Warwick quote at all. Every job is priced itemised in writing before we start."),
...
"Greenwood": dict(
    ...
    h1="Pest control in Greenwood, five minutes from our base.",
    ...
    pests=[
        ...
        ("Coastal brown ants", "Everywhere in Greenwood. Trails across paving, nests under pavers and along the edge of the lawn, and a kitchen incursion the moment the retic goes on. Treated as a colony, not a trail. <a href=\"/ant-control-perth\">Ant control</a>."),
        ("Rats and mice", "Roof voids with timber framing and sarking are warm and quiet. Entry is usually a lifted tile, an open eave gap or a gap around a flue. <a href=\"/rodent-control-perth\">Rodent control</a> here is mostly a proofing job."),
    ...
    faqs=[
        ...
        ("What does a general pest treatment cost in Greenwood?", "A typical three-bedroom home, internal and external, sits in the $250 to $350 range. Every job is quoted itemised in writing. <a href=\"/pest-control-prices-perth\">See the price guide</a>."),
    ]),
"Duncraig": dict(
    postcode="6023", drive="about 10 minutes", drive_short="10 minutes",
    h1="Pest control in Duncraig, where the sand meets the limestone.",
    ...
    pests=[
        ...
        ("Coastal brown ants", "Duncraig's limestone-and-sand mix suits them. Nests under paving and in retaining walls, super-colonies across fence lines. Non-repellent treatment and baits only. <a href=\"/ant-control-perth\">Ant control</a>."),
        ("Rodents", "Streets bordering Carine Open Space and the bush around Percy Doyle Reserve see the most winter rat activity. Proofing at the eaves and roof penetrations comes first. <a href=\"/rodent-control-perth\">Rodent control</a>."),
...
"Sorrento": dict(
    ...
    h1="Pest control in Sorrento, on the limestone above the marine park.",
    lead="Sorrento is coastal dune and Tamala limestone, salt air and a housing mix from 1970s brick-and-tile to new two-storey rebuilds on West Coast Drive. Pest control here is different from the inland suburbs and we treat it that way.",
    intro=[
    ...
    pests=[
        ...
        ("Rats", "Coastal reserves, the harbour precinct and salt-corroded roof flashings. Winter rodent work in Sorrento is a proofing job as much as a baiting one. <a href=\"/rodent-control-perth\">Rodent control</a>."),
...
"Hillarys": dict(
    ...
    h1="Pest control in Hillarys, from the harbour to Whitford City.",
    ...
    pests=[
        ("Coastal brown ants", "Hillarys is probably the suburb we treat for ants most. Pool surrounds, paving and limestone walls host super-colonies. Non-repellent product and baits, treated as a colony. <a href=\"/ant-control-perth\">Ant control</a>."),
        ("Rats and mice", "Harbour and shopping precincts feed them; roof voids and sheds house them. We proof first, then station. <a href=\"/rodent-control-perth\">Rodent control</a>."),
...
"Joondalup": dict(
    ...
    h1="Pest control in Joondalup, on the edge of Yellagonga.",
    ...
    pests=[
        ...
        ("Coastal brown ants", "Common across the suburb, worse towards the coast. Non-repellent treatment and baits so workers carry it back to the colony. <a href=\"/ant-control-perth\">Ant control</a>."),
        ("Rats in the roof", "Black rats enter through gutter joints, unsealed eaves and roof penetrations. Seal first, then tamper-resistant stations, then a follow-up check. <a href=\"/rodent-control-perth\">Rodent control</a>."),
...
"Wanneroo": dict(
    ...
    h1="Pest control in Wanneroo, market-garden country turned suburb.",
    ...
    pests=[
        ...
        ("Rats and mice", "Sheds, feed, firewood and the lake edge. Wanneroo rodent work usually means a proofing plan for the outbuildings as well as the house. <a href=\"/rodent-control-perth\">Rodent control</a>."),
        ...
        ("Ants, spiders and cockroaches", "Coastal brown ants on the sand, black ants around sheds, redbacks in stored timber and meter boxes, Australian cockroaches from mulch and compost. <a href=\"/general-pest-control-perth\">General pest treatment</a> and <a href=\"/ant-control-perth\">ant control</a>."),
    ],
...
"Balcatta": dict(
    ...
    h1="Pest control in Balcatta, homes and warehouses side by side.",
    ...
    pests=[
        ("Rats and mice", "Industrial food waste, old sheds and timber-framed roof voids. Balcatta is a rodent suburb in winter. We proof the roofline, place tamper-resistant stations and follow up. <a href=\"/rodent-control-perth\">Rodent control</a>."),
        ...
        ("Cockroaches", "American cockroaches from drains and the industrial precinct, German cockroaches in busy kitchens and food businesses. Gel bait and IGR programs, non-staining products indoors. <a href=\"/cockroach-control-perth\">Cockroach control</a>."),
        ("Ants and spiders", "Coastal brown ants along paving and retaining walls, black ants in vegetable gardens, redbacks in sheds and under old garden furniture. <a href=\"/ant-control-perth\">Ant control</a> and <a href=\"/general-pest-control-perth\">general pest treatment</a>."),
    ],
...
def pages(c):
    ...
    def svc_cards():
        return ('<div class="grid grid-4">'
            ...
            + c["card"]("Ant control", "Coastal brown ant super-colonies treated with non-repellents and baits, not a quick spray.", "/ant-control-perth", "Ants")
            + c["card"]("Rodent control", "Species identified, entry points sealed, tamper-resistant stations placed and checked.", "/rodent-control-perth", "Rodents")
            + '</div>')

    def price_note(sub):
        return (f'<div class="callout"><p><strong>What it costs in {esc(sub)}.</strong> A general pest treatment for a three-bedroom home is typically $250 to $350, an external ant treatment $250 to $400, '
                ...
                f'<a href="/pest-control-prices-perth">See the full price guide</a>.</p></div>')
  ...
  <ul class="trust"><li>Licensed technicians</li><li>In Perth pest control since {S['family_since']}</li><li>Itemised price in writing</li><li>Same-day for active pests</li></ul>
        ...
        services = c["section"](
            c["eyebrow"]("Services") + f'<div class="section-head"><h2>Four jobs we do every week in {name}.</h2></div>' + svc_cards() + price_note(name))

        nb = "".join(c["card"](n, f"Pest control in {esc(n)}, {DRIVE[n]} from Warwick.", slug(n), "Neighbouring suburb", more="See suburb page") for n in d["neighbours"])
        ...
        body = hero + intro + pests + now + services + neighbours + faq_sec + c["quote_block"](f"Get a fair, itemised price in {name}.")
        out.append({
            "path": slug(name),
            ...
            "schema": [{
                "@type": "Service", "serviceType": f"Pest control in {name}",
                "description": f"Termite inspection, general pest, ant and rodent control for {name} homes and businesses, {d['drive']} from DJ Pest's base in Warwick.",
  ...
  <div class="actions">{c['btn_call']()}{c['btn_quote']()}</div>
    ...
    why = c["section"](
        ...
        + c["card"]("No travel in the quote", "No call-out fee anywhere in the service area. Every job is priced itemised in writing before we start.")
    ...
    hub_faqs = [
        ("Do you service suburbs not on the list?", "Sometimes, if it is adjacent to the area, for example Trigg, North Beach, Scarborough or Edgewater. Ring and we will tell you straight. We do not take work south of the river or in the hills; the drive would end up in your price and the service would suffer."),
    ...
    out.insert(0, {
        ...
        "body": hub_hero + why + groups + eight + drive + hub_faq + c["quote_block"]("Get a fair, itemised price anywhere in the northern suburbs."),
        "crumbs": [("Service areas", None)],
        "schema": [c["faq_schema"](hub_faqs), {
            "@type": "Service", "serviceType": "Pest control, Perth northern suburbs",
            "provider": {"@id": S["domain"] + "/#business"},
