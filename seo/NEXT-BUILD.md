...
**~30% of 14-day plan. DAY 74 — NO CHANGE IN HTML FILES SINCE 8 AUG (6 days idle).**

---

## TODAY'S TASKS (priority order)

### 1. ⬆️ Upgrade `wanneroo.html` ← **DAY 74. STILL 20 MINUTES. DO IT NOW.**

**Keyword:** `pest control wanneroo` — local intent, low KD, directional traffic

**Current state:** 1443w · v1 schema (3 blocks, 12 @type refs) · missing FAQPage, GeoCoordinates, OpeningHoursSpecification
...
**Current state:** 1507w · v1 schema (3 blocks, 12 @type refs) · same gaps as wanneroo
...
### 3. 💰 Build `pest-control-cost-perth.html` ← drafts are written, this is purely assembly

**Keywords:** `how much does pest control cost` — 1300/mo, KD8 · `pest control prices` — 720/mo, KD6

**Drafts ready to merge:**
...
**Why now:** Three overlapping drafts = merge into one authoritative Perth pricing page with real $ tables. No competitor does transparent pricing. Dane's CA background = "no hidden fees" E-E-A-T angle every AI independently flagged. ~45 min: combine drafts → add HowTo + FAQPage schema → link from homepage + all 4 service pages → push. This is the MOFU moat the battle plan calls the highest-leverage move.
...
- **GBP is still the #1 unblocked lever.** Google Business Profile + review-generation engine > any page built today. If it isn't verified and running, that is the first call to make.
- **74 days on the same carry-over.** Wanneroo is one copy-paste and 3 sentence rewrites. The drafts for Task 3 are already written. The only step left is to open the file.
