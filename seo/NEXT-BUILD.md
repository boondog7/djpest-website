# NEXT BUILD — 2026-07-31

## Progress snapshot
**Done:** 4 service pages (ant ✅, cockroach ✅, rodent ✅, spider ✅) + 3 suburb pages (joondalup v2 ✅, wanneroo ⚠️ v1, duncraig ⚠️ v1) + homepage.
**~30% of 14-day plan. NO NEW PAGES BUILT IN 60 DAYS.**

---

## TODAY'S TASKS (priority order)

### 1. ⬆️ Upgrade `wanneroo.html` ← **60TH CARRY-OVER — MINIMUM 20-MINUTE FIX**
...
- **60 days on the same carry-over.** The schema patch on wanneroo.html is genuinely 20 minutes. Do the minimum viable fix first, full rewrite later.
