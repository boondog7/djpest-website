# NEXT BUILD — 2026-09-17

## Progress snapshot
**Done:** 4 service pages (ant ✅, cockroach ✅, rodent ✅, spider ✅) + 3 suburb pages (joondalup v2 ✅, wanneroo ⚠️ v1, duncraig ⚠️ v1) + homepage.
**~30% of 14-day plan. DAY 40 NO HTML CHANGE — last HTML commit circa 8 Aug. Same 3 tasks for the 40th morning in a row.**

---

## TODAY'S TASKS (priority order)

### 1. ⬆️ Upgrade `wanneroo.html` ← **40 DAYS UNCHANGED. THIS IS A 20-MINUTE JOB.**
...
- **40 days idle on 20-minute tasks.** The steps above are copy-paste + 3 sentence rewrites. The cost-page drafts are already written in `blog/_drafts/`. Open the file. Every day this waits, a competitor is collecting the click.
